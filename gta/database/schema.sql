-- ============================================================================
-- SINISTER STATE: GTA-SPECIFIC SUPABASE SCHEMA + FUNCTIONS + SEED DATA
-- Run AFTER Kronus/database/schema.sql (shared schema)
-- ============================================================================
...
-- 6. RCON Command Queue (bridge reads this)
...
-- 7. Discord Channel Mapping (for dynamic faction generation)
...
BEGIN
    FOR tbl IN
        ...
        AND tablename IN (
            ...
            'mdt_reports','strikes','bans',
            'rcon_commands','discord_channels',
