...
Config.PresetTables = {
    { coords = vec4(-1582.0, -520.0, 35.0, 340.0), label = 'The Spindletop' },
    { coords = vec4(-1222.0, -907.0, 12.0, 210.0), label = 'Coffee Kiosk' },
}

Config.Locale = 'en'
Config.CommandPrefix = 'chess'
