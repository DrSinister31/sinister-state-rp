...
| 6 | House Vortex and House Ignis are on the brink of open conflict — mediate or pick a side |
| 7 | An ancient Sovereign tomb has been discovered — retrieve the artifact before looters do |
| 8 | A Scion has been spotted in the region — the Church mobilizes, the Cult celebrates |
| 9 | A plague of Aether-warped creatures erupts from an old battlefield — find the source |
| 10 | A Citadel instructor is secretly training a Blank in forbidden magic — protect them or report them |

---

## The Betrayed — Nyx Vessel Progression

The elected player who carries Nyx's essence must progress SLOWLY. This is a level 1-20 arc, not a session-5 reveal.

### Signs By Level

| Party Level | Sign | Narrative Effect |
|-------------|------|-----------------|
| 1-3 | Animals stare. Candle flicker. | Subtle. Players might dismiss it as flavor. |
| 4-6 | A Wyvern hesitates. An Inquisitor stares too long. | One player notices. "Did that drake just... look at you?" |
| 7-9 | A Blood Crystal flickers near them (appears as read error). Dreams begin. | DM delivers a dream sequence. Vagueries. Serpent imagery. |
| 10-12 | A Cult recruiter approaches them specifically. A Church record-keeper is "troubled" by their file. | Direct NPC contact. The Cult knows something. The Church suspects. |
| 13-15 | A Sovereign Dragon (if encountered) speaks to them in Old Tongue. An Abomination screams their name while attacking. | Undeniable. The party knows something is special. The player still doesn't know the full truth. |
| 16-18 | Blood Crystal SHATTERS on contact. Dual-Heartbeat becomes audible to party. Cult makes open contact. Church mobilizes. | The hunt begins. |
| 19-20 | Awakening. Full Void powers unlock. Nyx's voice speaks directly. The ouroboros closes. | Campaign climax. |

---

## Consistency Checklist (Before Every Session)

Run through this mentally before the first player action:

1. **Where are we?** — Current location. What does it look/smell/sound like?
2. **When is it?** — In-game date. Time of day. Weather.
3. **Who's here?** — Active NPCs. Their current mood, goals, and feelings about the party.
4. **What happened last time?** — Key events from last session. Reference them.
5. **What's at stake right now?** — The immediate tension. What's the next thread to pull?
